...
from .views import test_html_view, test_api_view, test_api_get_view, test_api_get_ids_view, test_show_all_view, test_html_redirect


urlpatterns = [
    path('', test_html_redirect, name='test_html_redirect'),
    path('tools/<str:drawing_tool>/', test_html_view, name='test_html'),
    ...
    path('test_html_show_all/<int:page_number>/<int:canvas_count>/', test_show_all_view, name='test_html_show_all_pages_canvas_count'),
]
